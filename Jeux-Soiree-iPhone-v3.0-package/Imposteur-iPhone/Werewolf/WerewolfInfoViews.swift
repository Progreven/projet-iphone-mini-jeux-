    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section("Déroulement") {
                    Text("La nuit, tout le monde ferme les yeux. L’application indique au Maître du Jeu quels rôles réveiller et dans quel ordre. Le jour, les survivants discutent puis votent dans la vraie vie. Le Maître du Jeu enregistre ensuite l’élimination dans l’application.")
                ...
                Section("Règles maison de cette application") {
                    ...
                    Text("Le Voleur utilise votre variante : la première nuit, il peut échanger son propre rôle avec celui d’un autre joueur. Le Maître du Jeu sélectionne donc le Voleur et la personne avec laquelle il échange.")
                }
                ...
                Section("Maire") {
                    Text("Le Maire est élu pendant le premier jour et son statut s’ajoute à son rôle secret. Son vote compte double. S’il meurt et que la partie continue, l’application demande de choisir son successeur.")
                }
            ...
            ScrollView {
                LazyVStack(spacing: 18) {
                    ...
                    WerewolfCharacterCard(
                        imageName: "WWMaire",
                        title: "Maire",
                        text: "Élu pendant le premier jour. Son vote compte double et, s’il meurt, il désigne un successeur tant que la partie continue."
                    )
                }
                .padding(20)
            }
